...
Branch - a version of the project that is saved within the repository
Clone - to make a copy of a repository
Commit - saving the changes within the project that are within your local repository
Fetch - a command that downloads commits, files and refs from a remote repository
GIT - the most common version-control system that can be used to work, save and collaborate on projects
Github - the website that makes using git much easier
Merge - taking a branch from a repository and adding its changes to another repository
Merge Conflict - it is an error that happens when git isnt able to automatically resolve the differences in code between two commits
Push - a command that allows you to add the saved changes into the branch of your remote repository
Pull - a command that takes the files, refs and commits and adds them into your local repository
Remote - a git repository hosted on the internet or another network
Repository - a place where the entire project including all of its accessable versions are kept
